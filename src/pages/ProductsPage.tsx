...
export function ProductsPage() {
  ...
  const hasActiveFilters = family !== "all" || range !== "all" || brand !== "all" || search !== "";
          ...
          <div className="relative z-40 mb-7 w-full min-[781px]:sticky min-[781px]:top-[5rem]">
            ...
            >
              ...
              <div className="flex items-end gap-3 max-[1080px]:hidden">
                ...
                {/* 3 filter selects — grow to fill remaining space */}
              ...
              {/* Tablet / Mobile: search full width + toggle + reset row */}
